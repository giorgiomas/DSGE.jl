"""
```
myModel1010{T} <: AbstractRepModel{T}
```

The `myModel1010` type defines the structure of myModel1010.
...
"""
mutable struct myModel1010{T} <: AbstractRepModel{T}
...
description(m::myModel1010) = "New York Fed DSGE Model m1010, $(m.subspec). Model1009, with trend and stationary components in the safety and liquidity premia processes."

"""
`init_model_indices!(m::myModel1010)`

Arguments:
`m:: myModel1010`: a model object

Description:
Initializes indices for all of `m`'s states, shocks, and equilibrium conditions.
"""
function init_model_indices!(m::myModel1010)
    # Endogenous states
    endogenous_states = [[
...
function myModel1010(subspec::String="ss20";
...
those).
"""
function init_parameters!(m::myModel1010)
...
function model_settings!(m::myModel1010)
...
"""
```
parameter_groupings(m::myModel1010)
```
...
`prior_table`.
"""
function parameter_groupings(m::myModel1010)
