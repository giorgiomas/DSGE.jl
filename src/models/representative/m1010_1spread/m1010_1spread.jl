"""
```
Model1010_1spread{T} <: AbstractRepModel{T}
```

The `Model1010_1spread` type defines the structure of Model1010_1spread.
...
"""
mutable struct Model1010_1spread{T} <: AbstractRepModel{T}
...
description(m::Model1010_1spread) = "New York Fed DSGE Model m1010, $(m.subspec). Model1009, with trend and stationary components in the safety and liquidity premia processes."

"""
`init_model_indices!(m::Model1010_1spread)`

Arguments:
`m:: Model1010_1spread`: a model object

Description:
Initializes indices for all of `m`'s states, shocks, and equilibrium conditions.
"""
function init_model_indices!(m::Model1010_1spread)
    # Endogenous states
    endogenous_states = [[
...
function Model1010_1spread(subspec::String="ss20";
...
"""
```
init_parameters!(m::Model1010_1spread)
```
...
those).
"""
function init_parameters!(m::Model1010_1spread)
...
function model_settings!(m::Model1010_1spread)
...
"""
```
parameter_groupings(m::Model1010_1spread)
```
...
`prior_table`.
"""
function parameter_groupings(m::Model1010_1spread)
