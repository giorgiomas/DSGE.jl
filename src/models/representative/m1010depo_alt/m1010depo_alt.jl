"""
```
Model1010depo_alt{T} <: AbstractRepModel{T}
```

The `Model1010depo_alt` type defines the structure of Model1010depo_alt.
...
"""
mutable struct Model1010depo_alt{T} <: AbstractRepModel{T}
...
description(m::Model1010depo_alt) = "New York Fed DSGE Model m1010, $(m.subspec). Model1009, with trend and stationary components in the safety and liquidity premia processes."

"""
`init_model_indices!(m::Model1010depo_alt)`

Arguments:
`m:: Model1010depo_alt`: a model object

Description:
Initializes indices for all of `m`'s states, shocks, and equilibrium conditions.
"""
function init_model_indices!(m::Model1010depo_alt)
    # Endogenous states
    endogenous_states = [[
...
function Model1010depo_alt(subspec::String="ss20";
...
"""
```
init_parameters!(m::Model1010depo_alt)
```
...
those).
"""
function init_parameters!(m::Model1010depo_alt)
    ...
    m <= parameter(:lnb, 0.73/4, (1e-5, 10.), (1e-5, 10.), ModelConstructors.Exponential(), GammaAlt(0.73/4, 0.05), fixed=true, scaling = x -> (1 + x/100),
                   description="ln(b): Convenience yield premium.",
                   tex_label="ln(b)")
...
function model_settings!(m::Model1010depo_alt)
...
function parameter_groupings(m::Model1010depo_alt)
    ...
    financial   = [:Fω, :spr, :ζ_spb, :γ_star, :lnb]
