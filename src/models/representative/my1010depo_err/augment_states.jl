...
"""
function augment_states(m::myModel1010depo_err, TTT::Matrix{T}, RRR::Matrix{T}, CCC::Vector{T}) where {T<:AbstractFloat}
    ...
    TTT_aug[endo_new[:e_deprate_t], endo_new[:e_deprate_t]] = m[:ρ_deprate]
    ...
    # Measurement Error on deposit rate
    RRR_aug[endo_new[:e_deprate_t], exo[:deprate_sh]] = 1.0
