"""
```
Model1010depo{T} <: AbstractRepModel{T}
```

The `Model1010depo` type defines the structure of Model1010depo.
...
"""
mutable struct Model1010depo{T} <: AbstractRepModel{T}
...
description(m::Model1010depo) = "New York Fed DSGE Model m1010, $(m.subspec). Model1009, with trend and stationary components in the safety and liquidity premia processes."

"""
`init_model_indices!(m::Model1010depo)`

Arguments:
`m:: Model1010depo`: a model object

Description:
Initializes indices for all of `m`'s states, shocks, and equilibrium conditions.
"""
function init_model_indices!(m::Model1010depo)
    # Endogenous states
    endogenous_states = [[
...
function Model1010depo(subspec::String="ss20";
...
"""
```
init_parameters!(m::Model1010depo)
```
...
those).
"""
function init_parameters!(m::Model1010depo)
...
function model_settings!(m::Model1010depo)
...
"""
```
parameter_groupings(m::Model1010depo)
```
...
`prior_table`.
"""
function parameter_groupings(m::Model1010depo)
