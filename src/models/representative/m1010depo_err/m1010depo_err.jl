"""
```
Model1010depo_err{T} <: AbstractRepModel{T}
```

The `Model1010depo_err` type defines the structure of Model1010depo_err.
...
"""
mutable struct Model1010depo_err{T} <: AbstractRepModel{T}
...
description(m::Model1010depo_err) = "New York Fed DSGE Model m1010, $(m.subspec). Model1009, with trend and stationary components in the safety and liquidity premia processes."

"""
`init_model_indices!(m::Model1010depo_err)`

Arguments:
`m:: Model1010depo_err`: a model object

Description:
Initializes indices for all of `m`'s states, shocks, and equilibrium conditions.
"""
function init_model_indices!(m::Model1010depo_err)
    # Endogenous states
    endogenous_states = [[
        ...
        :rktil_f_t, :n_f_t, :b_liqtil_t, :b_liqp_t, :b_safetil_t, :b_safep_t, :Rd_t];
    ...
    equilibrium_conditions = [[
        ...
        :eq_b_safetil, :eq_b_safep, :eq_dep];
...
function Model1010depo_err(subspec::String="ss20";
...
"""
```
init_parameters!(m::Model1010depo_err)
```
...
those).
"""
function init_parameters!(m::Model1010depo_err)
...
function model_settings!(m::Model1010depo_err)
...
"""
```
parameter_groupings(m::Model1010depo_err)
```
...
`prior_table`.
"""
function parameter_groupings(m::Model1010depo_err)
