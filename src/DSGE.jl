...
module DSGE
    ...
    include("models/representative/my1010/my1010.jl")
    include("models/representative/my1010/subspecs.jl")
    include("models/representative/my1010/eqcond.jl")
    include("models/representative/my1010/observables.jl")
    include("models/representative/my1010/measurement.jl")
    include("models/representative/my1010/pseudo_observables.jl")
    ...
    include("models/representative/m1010depo/measurement.jl")
    include("models/representative/m1010depo/pseudo_observables.jl")
    ...
    include("models/representative/my1010depo/measurement.jl")
    include("models/representative/my1010depo/pseudo_observables.jl")
    include("models/representative/my1010depo/pseudo_measurement.jl")
    include("models/representative/my1010depo/augment_states.jl")

    include("models/representative/m1010depo_alt/m1010depo_alt.jl")
    include("models/representative/m1010depo_alt/subspecs.jl")
    include("models/representative/m1010depo_alt/eqcond.jl")
    include("models/representative/m1010depo_alt/observables.jl")
    include("models/representative/m1010depo_alt/measurement.jl")
    ...
    include("models/representative/m805_alt/m805_alt.jl")
    include("models/representative/m805_alt/subspecs.jl")
    include("models/representative/m805_alt/eqcond.jl")
    include("models/representative/m805_alt/observables.jl")
    include("models/representative/m805_alt/measurement.jl")
    include("models/representative/m805_alt/augment_states.jl")

    include("models/representative/m805_alt2/m805_alt2.jl")
    include("models/representative/m805_alt2/subspecs.jl")
    include("models/representative/m805_alt2/eqcond.jl")
    include("models/representative/m805_alt2/observables.jl")
    include("models/representative/m805_alt2/measurement.jl")
    include("models/representative/m805_alt2/augment_states.jl")
